...
yawFrame.place(x=10, y=200, height=30, width=100)
...
tk.Label(yawFrame,textvariable=tk_ImuYaw, fg='red',font=("Arial", 12)).pack(side='bottom',anchor='n')

pitchFrame= tk.Frame(AutoPage)
pitchFrame.place(x=130, y=200, height=30, width=100)
...
tk.Label(pitchFrame,textvariable=tk_ImuPitch, fg='red',font=("Arial", 12)).pack(side='bottom',anchor='n')


rollFrame= tk.Frame(AutoPage)
rollFrame.place(x=250, y=200, height=30, width=100)
...
tk.Label(rollFrame,textvariable=tk_ImuRoll, fg='red',font=("Arial", 12)).pack(side='bottom',anchor='n')
...
RfidPage.place(x=0, y=0, height=500, width=780)
...
Statustext = tk.Label(AutoPage, text='',textvariable=tk_MainStatusLine,font=("Arial", 20), fg='red')
Statustext.place(x=10,y=210, height=20, width=300)
Statetext = tk.Label(AutoPage, text='',textvariable=tk_MainStatusLine,font=("Arial", 20), fg='red')
Statetext.place(x=10,y=230, height=20, width=300)
"""
