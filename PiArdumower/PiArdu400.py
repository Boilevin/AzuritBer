...
#################################### VISION MANAGEMENT ###############################################
class vision_class(object):
    """class use to start and stop the vision"""
    def __init__(self):
        self.vision = None
        self.stdout=[]
    ...
    def start(self):
        #self.stop()
        print("start vision process")
        os.environ["PYTHONUNBUFFERED"]="1"
        self.vision=subprocess.Popen("/home/pi/Documents/PiArdumower/vision001.py",shell=True,stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
        stdout=[]
        
        #self.vision=subprocess.Popen(["/home/pi/Documents/PiArdumower/vision001.py"])
...
BtnVisionStart.place(x=280,y=250, height=25, width=60)
