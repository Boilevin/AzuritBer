...
imgBack=tk.PhotoImage(file=cwd + "/icons/backMedium.png")
...
MainPage.place(x=0, y=0, height=320, width=480)
...
ButtonSchedule.place(x=120,y=145,width=100, height=130)

ButtonCamera = tk.Button(MainPage, image=imgCamera, command = ButtonCamera_click)
ButtonCamera.place(x=230,y=145,width=100, height=130)

ButtonRfid = tk.Button(MainPage, image=imgRfid, command = ButtonRfid_click)
ButtonRfid.place(x=340,y=145,width=100, height=130)
"""
