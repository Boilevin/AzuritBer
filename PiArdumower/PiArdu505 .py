...
# Initialize frame rate calculation
    ...
    for frame1 in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):
        ...
        # Perform the actual detection by running the model with the image as input
            ...
            if ((myRobot.statusNames[mymower.status]=="NORMAL_MOWING") or (myRobot.statusNames[mymower.status]=="SPIRALE_MOWING")):
...
BtnVisionStart= tk.Button(FrameStreamVideo,command = BtnVisionStart_click,text="Vision Start")
BtnVisionStart.place(x=280,y=250, height=25, width=80)
BtnVisionStop= tk.Button(FrameStreamVideo,command = BtnVisionStop_click,text="Vision Stop")
BtnVisionStop.place(x=370,y=250, height=25, width=80)
