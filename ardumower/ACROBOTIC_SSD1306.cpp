...
{
  Wire1.beginTransmission(SSD1306_Address);    // begin I2C communication
  Wire1.write(SSD1306_Command_Mode);           // Set OLED Command mode
  Wire1.write(command);
...
{
     Wire1.beginTransmission(SSD1306_Address); // begin I2C transmission
     Wire1.write(SSD1306_Data_Mode);            // data mode
     Wire1.write(Data);
