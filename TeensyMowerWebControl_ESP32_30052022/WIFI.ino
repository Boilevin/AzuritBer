void connectWIFI() {
  ...
  if (SET_IP_SETTING == 0) {
    ...
    WiFi.setHostname("TeensyMowerESP");
...
void Check_WIFI() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (!wifiConnected) {
      ...
      Serial_ESP_to_USB.println(MSG_HEADER " ESP32-Wifi connected to AP ");
    ...
    if (wifiConnected) {
      ...
      Serial_ESP_to_USB.println(MSG_HEADER " ESP32-Wifi DISCONNECTED ");
