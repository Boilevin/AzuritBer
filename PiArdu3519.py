...
#scrollbar = tk.Scrollbar(RfidPage)
combobox = ttk.Combobox(RfidPage,font=("Arial", 10),values=tag_list, height=25, width=240)
...
def status_handler(event):
    current = combobox1.current()
    if current != -1:
        print(myRobot.statusNames[current])
combobox1 = ttk.Combobox(RfidPage,font=("Arial", 10),values=myRobot.statusNames, height=25, width=240)
combobox1.bind('<<ComboboxSelected>>', status_handler)
combobox1.current(0)
combobox1.place(x=100, y=35, height=20, width=240)



def todo_handler(event):
    current = combobox2.current()   
    if current != -1:
        print(ToDo_list[current])
combobox2 = ttk.Combobox(RfidPage,font=("Arial", 10),values=ToDo_list, height=25, width=240)
combobox2.bind('<<ComboboxSelected>>', todo_handler)
combobox2.current(0)
combobox2.place(x=100, y=65, height=20, width=240)
